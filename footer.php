    ...
    <footer role="contentinfo" id="p-footer" class="clear">
        ...
        <div class="col-1-4 first">
            ...
            <ul class="list underline nospace spacing">
                ...
                <li><a href="<?= ROOT_URL ?>/pages/blog.html">Blog</a></li>
...
<div class="wrapper row5">
    <div id="copyright" class="clear">
        <div id="sitename"><a class="uppercase button medium rnd8" href="<?=ROOT_URL?>"><span class="fa fa-refresh"></span> <em class="normal times"><?=$company['name']?></em></a></div>
