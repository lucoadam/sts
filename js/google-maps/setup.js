...
Template URI: https://www.os-templates.com/
Description: Designed and Built by <a href="https://www.os-templates.com/">OS Templates</a>. This modern template is adaptable, lightweight and fully customisable. The template is easy to use, enabling you to create your site within minutes.
Version: 1.0
...
function initialize() {
    ...
    var map = new google.maps.Map(document.getElementById('map_canvas_'), mapOptions);
    ...
    infowindow.setContent('<address>Company Name<br>Company Address<br>Post Code / Zip<br>Tel: xxxx xxxxxx</address>');
